...
public class ViewContentHandler {
    ...
    public ViewContentViewModel getRequiredDataForViewContent(String contentId)
    {
        ...
        viewContentViewModelInstance.setmSvgImages(contentInfoModelInstance.mSvgImages);
        viewContentViewModelInstance.setmPngImages(contentInfoModelInstance.mPngImages);
